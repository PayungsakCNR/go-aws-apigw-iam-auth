...
func hashedCanonicalRequest(request *http.Request, meta *metadata) string {
...
func prepareRequest(request *http.Request) *http.Request {
...
func buildAuthHeader(signature string, meta *metadata, accessKey string) string {
